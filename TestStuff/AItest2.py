...
api_key = 'AIzaSyCcVawGTBt73GJa61CnF9u-C1-_JM6-Spg'  # Replace with your Gemini API key (if available)
responce = input("Give the AI something to respond to: ")
question = f"Give a human like responce to this: {responce}"
